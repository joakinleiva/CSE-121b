...
// Step 1: Using function declaration, define a function named add that takes two arguments, number1 and num2
function add(number1, number2){
    return number1 + number2;
}


// Step 2: In the function, return the sum of the parameters number1 and num2

// Step 3: Using function declaration, define another function named addNumbers
